...
$constants = wpec_gd_paypal_constants();

/**
# Endpoint: this is the server URL which you have to connect for submitting your API request.
Change to https://svcs.paypal.com/  to go live */

define( 'API_BASE_ENDPOINT', $constants->API_BASE_ENDPOINT );
...
define( 'API_USERNAME', $constants->API_USERNAME );
define( 'API_PASSWORD',  $constants->API_PASSWORD );
define( 'API_SIGNATURE',  $constants->API_SIGNATURE );
...
define( 'X_PAYPAL_APPLICATION_ID', $constants->X_PAYPAL_APPLICATION_ID );

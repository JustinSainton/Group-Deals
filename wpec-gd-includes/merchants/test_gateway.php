...
*/
$nzshpcrt_gateways[4] = array(
	'name' => 'Test Gateway',
	'api_version' => 2.0,
	'class_name' => 'wpsc_merchant_testmode_gd',
	...
	'form' => 'form_testmode_gd',
	
	// this may be legacy, not yet decided
	'internalname' => 'wpsc_merchant_testmode',
);

class wpsc_merchant_testmode_gd extends wpsc_merchant {
